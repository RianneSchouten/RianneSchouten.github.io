...
Currently, I work in the Data Mining group at the TUe and study the Exceptional Model Mining framework. We work on developing solutions for heterogeneous datasets with time-dependent attributes. My supervisors are [dr. Wouter Duivesteijn](http://wwwis.win.tue.nl/~wouter/) and [prof. dr. Mykola Pechenizkiy](https://www.win.tue.nl/~mpechen/). 
...
If you have questions regarding exceptional model mining, missing data, statistical techniques, simulation studies or anything else related to data analysis, feel free to contact me (see below).

---

### Publications

- **In press**: IJsselhof R, Duchateau S, Schouten R, Slieker M, Hazekamp M & Schoof P. Untreated autologous pericardium for ventricular septal defect closure in atrioventricular septal defect repair. World Journal for Pediatric and Congenital Heart Surgery. Date of submission: 15-01-2020.
