...
subtitle: "Ph.D. candidate, defense on 16 Jan. 2025"
author: |
  | Local Pattern Mining | Reliability | Robustness | Hierarchical Data | Experimental Designs | Missing Data | Causality | 
date: ""
output: 
  html_document:
    toc: true
...
[See here for complete Curriculum Vitae](pdfs/Rianne_Schouten_Resume.pdf)
...
*2020 - Present*: Ph.D. Candidate at Eindhoven University of Technology, the Netherlands. 
Under supervision of [prof. Mykola Pechenizkiy](https://www.win.tue.nl/~mpechen/) and [dr. Wouter Duivesteijn](http://wwwis.win.tue.nl/~wouter/). 
Dissertation is submitted. Ph.D. defense scheduled for 16 Jan. 2025. 
Topic: **Exceptional Model Mining for Hierarchical Data**. 

*2017 - 2019*: Researcher at Utrecht University, the Netherlands.
Under supervision of [prof. dr. Stef van Buuren](https://scholar.google.nl/citations?user=_3y5C0UAAAAJ&hl=nl) and [dr. Gerko Vink](https://www.gerkovink.com/).
...
- **Schouten, R.M.** (2024) On the role of prognostic factors and effect modifiers in structural causal models. Accepted for presentation at Causal Representation Learning Workshop NeurIPS.
...
additional evaluation ofMisGAN. Accepted for presentation at BNAIC/BeNeLearn 2024. 
