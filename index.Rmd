...
Currently, I work in the Data Mining group at the TUe and study the Exceptional Model Mining framework. We work on developing solutions for problems with heterogeneity and dependent data points. My supervisors are dr. Wouter Duivesteijn and prof. dr. Mykola Pechenizkiy. 

It is important to me that my work has a useful application for real world problems. Especially the health care domain has my interest and I co-operated in several medical studies as a statistical advisor. 

If you have questions regarding missing data, statistical techniques, simulation studies or anything else related to data analysis, please contact me. I will try to help or otherwise refer you to someone else who could help.
...
- **Research accepted**: IJsselhof R, Duchateau S, Schouten R, et al. (2019) Follow-up After Biventricular Repair of the Hypoplastic Left Heart Complex. European Journal of Cardiothoracic Surgery.
