...
author: |
  | PhD Candidate / Missing Data Specialist / Developer Data & Analytics
date: ""
output: 
  html_document:
    toc: true
...
- Rianne Margaretha Schouten, Peter Lugtig & Gerko Vink (2018): [Generating missing values for simulation purposes: A multivariate amputation procedure](pdfs/ArticleAmpute.pdf). Journal of Statistical Computation and Simulation, DOI: 10.1080/00949655.2018.1491577
...
- Schouten, R.M. (2018) Evaluation of missing data methods in the data science framework: a comparison of statistical validity, prediction accuracy and imputation accuracy.
...
Dealing with missing data in R: Amputation or Imputation? Excited! 
...
- Form 1 available on request

- Education and Supervision Agreement available on request

- Annual Progress Report 1 not yet applicable
