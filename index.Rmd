...
- Rianne Margaretha Schouten, Peter Lugtig & Gerko Vink (2018): [Generating missing values for simulation purposes: A multivariate amputation procedure](https://doi.org/10.1080/00949655.2018.1491577), Journal of Statistical Computation and Simulation, DOI: 10.1080/00949655.2018.1491577

- Schouten, R.M. and Vink, G. (2017). The dance of the mechanisms: how observed information influences the validity of missingness assumptions. [Accepted and soon to be published in Sociological Methods \& Research]
...
R-function `ampute` is the implementation of a [multivariate amputation procedure](https://doi.org/10.1080/00949655.2018.1491577). With `ampute`, it is straightforward to generate missing values in multiple variables, with different missing data proportions and varying underlying missingness mechanisms. An extensive [vignette](https://rianneschouten.github.io/mice_ampute/vignette/ampute.html) is available.
