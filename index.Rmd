...
- [Under Review] Schouten, R.M., Duivesteijn, W. & Pechenizkiy, M. (2021) Exceptional Model Mining for Repeated Cross-Sectional Data (EMM-RCS).

- [Coming Soon] Schouten, R.M., de Paula Bueno, M.L., Duivesteijn, W. & Pechenizkiy, M. (2021) Mining Sequences with Exceptional Transition Behaviour of Varying Order using Quality Measures based on Information-Theoretic Scoring Functions. Data Mining and Knowledge Discovery (DAMI): European Conference on  Machine Learning and Principles and Practices of Knowledge Discovery (ECML-PKDD), journal track.
