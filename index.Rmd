...
R-function `ampute` is the implementation of a [multivariate amputation procedure](https://github.com/RianneSchouten/Amputation_with_Ampute/blob/master/Manuscript%20article/Manuscript.pdf). With `ampute`, it is straightforward to generate missing values in multiple variables, with different missing data proportions and varying underlying missingness mechanisms. An extensive [vignette](https://github.com/RianneSchouten/Amputation_with_Ampute/tree/master/Vignette) is available.
