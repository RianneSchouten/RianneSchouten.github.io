...
- [In press] Schouten, R.M., Duivesteijn, W. & Pechenizkiy, M. (2022) Exceptional Model Mining for Repeated Cross-Sectional Data (EMM-RCS). Siam International Conference on Data Mining (SDM).

- Schouten, R.M., Bueno, M.L.P., Duivesteijn, W. & Pechenizkiy, M. (2021) [Mining Sequences with Exceptional Transition Behaviour of Varying Order using Quality Measures based on Information-Theoretic Scoring Functions.](pdfs/MiningExceptionalSequences_DAMI_2021.pdf) Data Mining and Knowledge Discovery (DAMI), journal track of European Conference on Machine Learning and Principles and Practices of Knowledge Discovery (ECML-PKDD) 2022.
...
- Schouten, R.M. and Vink, G. (2018) [The dance of the mechanisms: How observed information influences the validity of missingness assumptions.](https://journals.sagepub.com/doi/full/10.1177/0049124118799376) Sociological Methods \& Research, 50(3): 1243-1258.
...
#### 3. `pymice`: a mice package in Python

It is my wish that Python-users have access to state-of-the-art missing data methods. Together with [Davina Zamanzadeh](https://github.com/davzaman), I am now developing the amputation part of the package. We are always looking for more collaborators! 

Find the code [here](https://github.com/RianneSchouten/pymice).
